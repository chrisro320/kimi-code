...
- **Subagents for focused, parallel work.** Dispatch built-in implementation, exploration, debugging, review, and frontend subagents in isolated contexts while keeping the main conversation clean.
