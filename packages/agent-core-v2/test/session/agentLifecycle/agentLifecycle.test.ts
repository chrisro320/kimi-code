...
describe('AgentLifecycleService', () => {
  ...
  beforeEach(() => {
    ...
    // The fork's AgentProfileService ctor depends on IFlagService; without this
    // stub the scope-created activation wave safe-skips it, and its replayable
    // `profile` state would be contributed only after the dispatcher restore.
